...
class ChunkStore:
    ...
    def print(self, total_saved_space):
        ...
        logging.info("Total ineffective size: " + str(self.total_ineffective_space))
        max_dd = (1 - self.total_store_size / self.total_ineffective_space) * 100
        real_dd = (1 - (self.total_ineffective_space - total_saved_space) / self.total_ineffective_space) * 100
