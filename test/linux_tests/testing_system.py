...
class LinuxDataTar(LinuxData):
    VERSION_5_12 = "linux-5.12.tar"
    VERSION_5_13 = "linux-5.13.tar"
    VERSION_5_14 = "linux-5.14.tar"
    VERSION_5_15 = "linux-5.15.tar"
    VERSION_5_16 = "linux-5.16.tar"
    VERSION_5_17 = "linux-5.17.tar"
...
class LinuxTest:
    ...
    def test_with_all_linux_versions_tars(self):
        versions = [version for version in LinuxDataTar]
        logging.info("------------------NEW TEST-------------------")
        logging.info("----TYPE: ALL LINUX TARS----")
        logging.info("-----WITH CONFIG: " + str(self.cfg) + " -----")
        logging.info("WITH LINUX VERSIONS:  " + str(versions))
        start_time = time.perf_counter()
        self.deduplicate_zips(versions)
